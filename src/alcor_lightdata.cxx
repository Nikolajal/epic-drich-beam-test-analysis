...
std::vector<trigger_event> alcor_lightdata::get_triggers() const { return lightdata.trigger_hits; }
...
std::vector<trigger_event> &alcor_lightdata::get_triggers_link() { return lightdata.trigger_hits; }
...
void alcor_lightdata::set_trigger(std::vector<trigger_event> v) { lightdata.trigger_hits = v; }
...
void alcor_lightdata::set_trigger_link(std::vector<trigger_event> &v) { lightdata.trigger_hits = v; }
...
std::optional<float> alcor_lightdata::get_trigger_time(uint8_t trigger_index)
{
    auto it = std::find_if(
        ...
        [trigger_index](const trigger_event &t)
