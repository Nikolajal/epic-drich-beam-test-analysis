                            ...
                            std::string conf_path = "ringtrack.conf")
{
    ...
    // -------------------------------------------------------------------------
    //  Canvas: zero-hit intercepts
    // -------------------------------------------------------------------------
    TCanvas *c_zero_hits = new TCanvas("c_zero_hits",
        "Track intercept at dRICH (0 hit events)", 800, 800);
    h_intercept_drich_zero_hits->Draw("COLZ");
